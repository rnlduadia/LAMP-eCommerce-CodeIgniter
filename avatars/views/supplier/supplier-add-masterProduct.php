			    ...
			    <li>
					<div class='product-cont padded-cont clearfix'>
						...
						<div class="fr half clearfix">
							<button class='fr normal-button step-format' id='step_5'>NEXT</button>	
						</div>
					</div>
			    </li>
			 </ul>
			    ...
			    <li>
					<div class='product-cont padded-cont clearfix'>
						...
						<div class="fl clearfix">
							...
							<div class="clear"> </div>
							<textarea id='prom_text'></textarea>
						</div>

	
						<div class="fr half clearfix">
							<input type='button' class='fr normal-button' id="submit-product" value="Save" />
						</div>
					</div>
			    </li>
			 </ul>			 
