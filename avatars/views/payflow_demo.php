...
<p><?php highlight_file($_SERVER['DOCUMENT_ROOT'].'/demo/codeigniter/includes/payflow_process_transaction.php'); ?></p>
<p><a href="/demo/codeigniter/paypal/payflow/process_transaction_demo" target="_blank">Run the code above and see the output.</a></p>
<p>&nbsp;</p>
</body>
</html>