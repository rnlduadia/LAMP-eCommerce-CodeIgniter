...
<script type="text/javascript">
	function assignCountry(id)
	{
		...
		$.post('<?php echo base_url() ?>carrier/assign',{sc_id:id,country:country,action:'add','<?php echo $this->security->get_csrf_token_name()?>':'<?php echo $this->security->get_csrf_hash()?>'},function(data){
