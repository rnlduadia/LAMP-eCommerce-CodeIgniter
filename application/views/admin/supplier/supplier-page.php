									...
									<td align="center">
										...
										<center>
											...
											<?php if($sup->u_admin_approve == 2 || $sup->u_admin_approve == 0 ){?>
												<a class='normal-link approve' href="<?php echo base_url()?>supplier/update/<?php echo $sup->u_id; ?>/approved">Approve</a>
											<?php }if($sup->u_admin_approve == 1 || $sup->u_admin_approve == 0 ){?>
												<a class='normal-link deny' href="<?php echo base_url()?>supplier/update/<?php echo $sup->u_id; ?>/denied">Deny</a>
											<?php }?>
										</center>
										<?php } ?>
									</td>
