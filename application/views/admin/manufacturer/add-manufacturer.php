...
<script type="text/javascript" language="javascript">
	...
	$(document).ready(function(){
		...
		$('#add-brand').click(function(){
			...
			if(sel_manufac != '')
			$.post('<?php echo base_url()?>brand/add',{name:name,manu_id:sel_manufac,action:'add','<?php echo $this->security->get_csrf_token_name()?>':'<?php echo $this->security->get_csrf_hash()?>'}, function(result){
	...
	{
		$('#popbrand').fadeIn();
		$.post('<?php echo base_url()?>brand/detail',{id:id,view_type:'table','<?php echo $this->security->get_csrf_token_name()?>':'<?php echo $this->security->get_csrf_hash()?>'},function(result){
	...
	{
		$.post('<?php echo base_url()?>manufacturer/delete',{id:id,type:'delete','<?php echo $this->security->get_csrf_token_name()?>':'<?php echo $this->security->get_csrf_hash()?>'},function(result){
	...
	{
		$.post('<?php echo base_url()?>brand/delete',{id:id,type:'delete','<?php echo $this->security->get_csrf_token_name()?>':'<?php echo $this->security->get_csrf_hash()?>'},function(result){
			alert(result);
		});
