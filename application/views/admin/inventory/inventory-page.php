...
<div class="global-cont">
	<div class='bg-body'>
		...
		<!-- MIDDLE PAGE CONTAINER-->
			...
			<div class='right-cont clearfix fr special-border'>
...
<div class='clear'></div>
				<div class='search-container clearfix'>
					...
					<div class="clearfix">
						<label for='brand'>SKU</label>
						<div class='clearfix'>
							<input type='text' value='' id='search-sku' class='normal-format-text' />
							<div class='float-dropdown' id='search-sku-result'></div>
						</div>
					</div>
				...
				<div id='result-inventory' class='violet-table'>
...
<script type="text/javascript" language="javascript">
	...
	function filter_product()
	{
		...
		$.post('<?php echo base_url()?>inventory/search?page=<?=$_GET['page']?>',{name:name,manu:manu,brand:brand,sku:sku,'<?php echo $this->security->get_csrf_token_name()?>':'<?php echo $this->security->get_csrf_hash()?>'},function(data){
