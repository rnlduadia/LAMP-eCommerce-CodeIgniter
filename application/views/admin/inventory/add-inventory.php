	...
	<div class='bg-body'>
		...
		<!-- MIDDLE PAGE CONTAINER-->
			...
			<div class='right-cont clearfix fr'>
				...
				<div id="product-tab">
					<!--<div class='no-click-cont-tab'></div>-->
					<ul class="nav">
				        <li class="nav-one">
...
<script type="text/javascript">
		...
		$('#submit-product').click(function(){
			...
			if(category == "" || manu == "" || brand == "")
			{
				var error_message = "";
				if(category == "")
					error_message += "Required to Select category \n";
				if(manu == "")
					error_message += "Manufacturer is Required \n";
				if(brand == "")
	...
	$('#step_3').click(function(){
		if(brand_sel != "" && manufacture_sel !="")
		{
			...
			if(isNaN($('#upc_ean').val())){
				$('.nav-three a').trigger('click');
				alert('Please enter numeric value for the UPC/EAN');
				return false;
			} else {
				$('.nav-three a').trigger('click');
			}
