	...
	<ul class="footerInfo floatL">
		...
		<li><a href='<?php echo base_url()?>buyer'>Catalog</a></li>
		<li><a href='<?php echo base_url()?>buyer/datafeed'>Feeds</a></li>
		<li><a href='<?php echo base_url()?>shipping/request'>Orders</a></li>
		<li><a href='<?php echo base_url()?>buyer/profile/buyer/view'>Manage My Account</a></li>
		<li><a href='<?php echo base_url()?>buyer/inbox'>Message Center</a></li>
