				...
				<div class='right-inner clearfix'>
					...
					<div class='padded-cont'>
						...
						<div class='clearfix'>
							...
							<div class='clear'></div>
							<input type='text' id='ccuccv' name="ccuccv" class='normal-format-text small45' maxlength='4' />
						</div>

						<div class='clearfix'>
							<label for='exp_month'>Expiration Date*</label>
							<div class='clear'></div>
							<select id='exp_month' class='normal-format-text medium'  name="exp_month">
								<?php echo $this->creditcards->generate_months('option'); ?>
							</select>
							<select id='exp_year' class='normal-format-text small'  name="exp_year">
								<?php
