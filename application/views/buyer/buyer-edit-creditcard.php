				...
				<div class='right-inner clearfix'>
					...
					<div class="topBrands searching-for">
						<div class="topBrandsHeader">
							<div class'floatl'="">Update Credit Card:</div>
						</div>
					</div>
					<div class='padded-cont'>
						...
						<div class='clearfix'>
							...
							<div class='clear'></div>
							<input type='text'  name="ccuccv" id="ccuccv" value="<?php echo $credit_info->ccu_ccv ?>" class='normal-format-text small45' maxlength='4' />
						</div>
		...
		$('#update-creditcard-button').click(function(){
				...
				action:'update','<?php echo $this->security->get_csrf_token_name()?>':'<?php echo $this->security->get_csrf_hash()?>'},function(result){
					...
					if (convert.status == 1)
					{
						...
						$(window.location).attr('href', "<?php echo base_url() ?>buyer/creditcard");
					}
