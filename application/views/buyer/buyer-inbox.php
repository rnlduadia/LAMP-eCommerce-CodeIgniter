									...
									<div class='violet-table'>
										<table>
											...
											<tr>
												...
												<td><a href='<?php echo base_url()?>buyer/inbox/<?php echo $message->bsm_id ?>'><?php echo $message->u_fname. ' '.$message->u_lname ?></a></td>
												<td><a href='<?php echo base_url()?>buyer/inbox/<?php echo $message->bsm_id ?>'><?php echo $message->bsm_subject ?></a></td>
												<td><a href='<?php echo base_url()?>buyer/order/<?php echo $message->bsd_id ?>'><?php echo $message->bt_invoice ?></a></td>
											</tr>
											<?php }}?>
										</table>
									</div>
								...
								<div class='product-cont padded-cont clearfix'>
									...
									<div class='violet-table'>
										<table>
											...
											<tr>
												<td><?php echo $message->bsm_time; ?></td>
												<td><a href='<?php echo base_url()?>buyer/inbox/<?php echo $message->bsm_id ?>'><?php echo $buyer->u_fname. ' '.$buyer->u_lname ?></a></td>
												<td><a href='<?php echo base_url()?>buyer/inbox/<?php echo $message->bsm_id ?>'><?php echo $message->bsm_subject ?></a></td>
												<td><a href='<?php echo base_url()?>buyer/order/<?php echo $message->bsd_id ?>'><?php echo $message->bt_invoice ?></a></td>
											</tr>
											<?php }}?>
