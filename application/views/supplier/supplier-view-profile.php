				...
				<div class='right-inner clearfix'>
					...
					<div class='padded-cont'>
						...
						<div class='informative-format fl'>
							...
							<div>
								<p><span>Order Notifications Email:</span> <?php echo !empty($supplier_profile->u_additional_email)?$supplier_profile->u_additional_email:$supplier_profile->u_email; ?></p>
							</div>
...
<br/>
				...
				<div class='right-inner right-inner-half-fr clearfix fl' style='min-height:215px'>
					...
					<div class="topBrands searching-for">
						<div class="topBrandsHeader">
							<div class'floatl'="">Current Sales</div>
						</div>
					</div>
					<div class='padded-cont'>
						<div class='informative-format fl'>
