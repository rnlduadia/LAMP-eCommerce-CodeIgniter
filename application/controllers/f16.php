...
class F16 extends CI_Controller {
    ...
    public function home($page = 'account')
    {
    	if($this->session->userdata('logged_in') == TRUE){
			...
			$data['logs'] =  $this->accounts_model->logs(1,$this->session->userdata('id'));
			...
			$this->load->view('templates/header-f16', $data);
			$this->load->view('f16/account', $data);
			$this->load->view('templates/footer-f16');
		}
		else
		{
    ...
    public function index($page = 'home') {
		if($this->session->userdata('logged_in') == TRUE)
		{
			...
			if($page == 'level-1'){
				$data_user['lvl'] = 1;
				$data_user['contents'] = $this->accounts_model->page_content('f16', $data_user['lvl'], $lang);
				$this->load->view('f16/level-1', $data_user);
	        }else if($page == 'level-2'){
	        	$data_user['lvl'] = 2;
	        	$data_user['contents'] = $this->accounts_model->page_content('f16', $data_user['lvl'], $lang);
				$this->load->view('f16/level-2', $data_user);
	        }else if($page == 'level-3'){
	        	$data_user['lvl'] = 3;
	        	$data_user['contents'] = $this->accounts_model->page_content('f16', $data_user['lvl'], $lang);
				$this->load->view('f16/level-3', $data_user);
	        }else if($page == 'level-4'){
	        	$data_user['lvl'] = 4;
	        	$data_user['contents'] = $this->accounts_model->page_content('f16', $data_user['lvl'], $lang);
				$this->load->view('f16/level-4', $data_user);
	        }else if($page == 'level-5'){
	        	$data_user['lvl'] = 5;
	        	$data_user['contents'] = $this->accounts_model->page_content('f16', $data_user['lvl'], $lang);
				$this->load->view('f16/level-5', $data_user);
	        }else if($page == 'level-6'){
	        	$data_user['lvl'] = 6;
	        	$data_user['contents'] = $this->accounts_model->page_content('f16', $data_user['lvl'], $lang);
				$this->load->view('f16/level-6', $data_user);
	        }else if($page == 'level-7'){
	        	$data_user['lvl'] = 7;
	        	$data_user['contents'] = $this->accounts_model->page_content('f16', $data_user['lvl'], $lang);
				$this->load->view('f16/level-7', $data_user);
	        }else if($page == 'level-8'){
	        	$data_user['lvl'] = 8;
	        	$data_user['contents'] = $this->accounts_model->page_content('f16', $data_user['lvl'], $lang);
				$this->load->view('f16/level-8', $data_user);
	        }else if($page == 'level-9'){
	        	$data_user['lvl'] = 9;
	        	$data_user['contents'] = $this->accounts_model->page_content('f16', $data_user['lvl'], $lang);
				$this->load->view('f16/level-9', $data_user);
	        }else if($page == 'level-10'){
	        	$data_user['lvl'] = 10;
	        	$data_user['contents'] = $this->accounts_model->page_content('f16', $data_user['lvl'], $lang);
				$this->load->view('f16/level-10', $data_user);
	        }
