 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'vav802_api1.yandex.ru' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '1398226527' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AjPbz2wNccNsvY02V2qrPyASd4jfA1ucv0dIpDuc7XgjkPnkCMsoYYVr' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['PayFlowUsername'] = $config['Sandbox'] ? 'sbseller802' : 'PRODUCTION_USERNAME_GOGES_HERE';//3R6NU26VWL
$config['PayFlowPassword'] = $config['Sandbox'] ? 'Password1' : 'PRODUCTION_PASSWORD_GOES_HERE';//EI3OPVQ7DE8O1131
$config['PayFlowVendor'] = $config['Sandbox'] ? 'vav802yandex' : 'PRODUCTION_VENDOR_GOES_HERE'; //32K7FTY8WK
 ...
 */
$config['DeveloperEmailAccount'] = 'vav802@gmail.com';
