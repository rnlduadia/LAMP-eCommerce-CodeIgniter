...
<div id="page-body">
	<div id="sidebar">
		<div id="help" class="widget">
			...
			<br />
			<p>If you get a 404 or 500 error on login after the install process please check to ensure the Apache Mod Rewrite module is enabled.</p>
		</div>
			...
			<?php if (isset($message)) echo '<div class="message">' . ipm_htmlentities($message) . '</div>'; ?>
				...
				<table class="data-table">
					...
					<tr <?php if ($i % 2 == 0 ) { echo 'class="switch-1"'; } else { echo 'class="switch-2"'; }; ?>>
						...
						<td class="centre">Found <?php echo $system_check['php_version']; ?>, Required for Base System</td>
					</tr>
					<?php $i++; ?>
					<tr <?php if ($i % 2 == 0 ) { echo 'class="switch-1"'; } else { echo 'class="switch-2"'; }; ?>>
					...
					<tr <?php if ($i % 2 == 0 ) { echo 'class="switch-1"'; } else { echo 'class="switch-2"'; }; ?>>
						...
						<td class="centre">Required to Write user/system/config.php File</td>
					</tr>
				</table>
