...
<div id="page-body">
	...
	<div id="box">
		<div id="content">
			...
			<br />
			<div class="message">Although there is no License Key this application is not free. You may install a single copy for each purchase from Codecanyon. Please do not share this application.</div>
			<br />
